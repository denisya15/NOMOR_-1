...
# User Interface
User.Interface <- dashboardPage(skin = "green",
...
server <- function(input, output) {
  ...
  output$monthly_sales_plot <- renderPlot({
    warna_bulan <- c("jan" = "#93bf85", "feb" = "#b7d5ac", "mar" = "#008000", "apr" = "#F3FBEF",
                     "may" = "#0f6a08", "jun" = "#469536", "jul" = "#6eaa5e", "aug" = "#EEF9E9", 
                     "sep" = "#132c0d", "oct" = "#15400e", "nov" = "#14540d", "dec" = "#dbead5")
